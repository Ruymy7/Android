...
public class PauseCommand implements IParsedNdefCommand {

	public static final String RECORD_TYPE = IParsedNdefCommand.COMMAND_PAUSE;

	private final String mId;

	private final String mColor;

	public PauseCommand(String id) {
