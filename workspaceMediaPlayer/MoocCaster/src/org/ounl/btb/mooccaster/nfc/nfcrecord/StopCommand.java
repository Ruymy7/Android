...
public class StopCommand implements IParsedNdefCommand {

	public static final String RECORD_TYPE = IParsedNdefCommand.COMMAND_STOP;

	private final String mId;

	private final String mColor;

	public StopCommand(String id) {
