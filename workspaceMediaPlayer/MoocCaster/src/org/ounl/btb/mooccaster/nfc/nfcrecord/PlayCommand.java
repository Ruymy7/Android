...
public class PlayCommand implements IParsedNdefCommand {

	public static final String RECORD_TYPE = IParsedNdefCommand.COMMAND_PLAY;

	private final String mId;

	private final String mColor;

	public PlayCommand(String id) {
