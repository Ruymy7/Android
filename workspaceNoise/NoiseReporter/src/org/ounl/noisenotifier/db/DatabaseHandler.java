...
public class DatabaseHandler extends SQLiteOpenHelper {
	...
	public List<NoiseSaladPJ> getSalat(String sTag, double dMin, double dStep) {
		...
		String selectQuery = " ";
		selectQuery += " SELECT 'Broccoli', count(*) ";
		...
		selectQuery += " UNION";
		selectQuery += " SELECT 'Puerro', count(*)";
		selectQuery += " FROM noisesample ";
		selectQuery += " where ";
		selectQuery += " 	tag = '"+ sTag +"'"; 
		selectQuery += " 	AND";
		...
		selectQuery += " UNION";
		selectQuery += " SELECT 'Star fruit', count(*)";
		selectQuery += " FROM noisesample ";
		selectQuery += " where ";
		selectQuery += " 	tag = '"+ sTag +"'"; 
		selectQuery += " 	AND";
		...
		selectQuery += " UNION";
		selectQuery += " SELECT 'Limon', count(*)";
		selectQuery += " FROM noisesample ";
		selectQuery += " where ";
		selectQuery += " 	tag = '"+ sTag +"'"; 
		selectQuery += " 	AND";
		...
		selectQuery += " UNION";
		selectQuery += " SELECT 'Papaya', count(*)";
		selectQuery += " FROM noisesample ";
		selectQuery += " where ";
		selectQuery += " 	tag = '"+ sTag +"'"; 
		selectQuery += " 	AND";
		...
		selectQuery += " UNION";
		selectQuery += " SELECT 'Orange', count(*)";
		selectQuery += " FROM noisesample ";
		selectQuery += " where ";
		selectQuery += " 	tag = '"+ sTag +"'"; 
		selectQuery += " 	AND";
		...
		selectQuery += " UNION";
		selectQuery += " SELECT 'Paprika', count(*)";
		selectQuery += " FROM noisesample ";
		selectQuery += " where ";
		selectQuery += " 	tag = '"+ sTag +"'"; 
		selectQuery += " 	AND";
